...
def covid_vaccine_topic(body=None):  # noqa: E501
    ...
    :param body: A tuple of the target topic id and the body of text to analyze.
    :type body: dict | bytes

    :rtype: CovidTopicResponse
    """
    if connexion.request.is_json:
        body = CovidTopicRequest.from_dict(connexion.request.get_json())  # noqa: E501
